...
migrate:
	migrate -source file://postgres/migrations \
			-database postgresql://postgres:dreamer@20.203.31.58:5432/twitter?sslmode=disable up

rollback:
	migrate -source file://postgres/migrations \
			-database postgresql://postgres:dreamer@20.203.31.58:5432/twitter?sslmode=disable down 1

drop:
	migrate -source file://postgres/migrations \
			-database postgresql://postgres:dreamer@20.203.31.58:5432/twitter?sslmode=disable drop
